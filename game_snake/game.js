let Snake = (function () {
    ...
    let game = {
        ...
        insertDirection: {
            up: function () {
                if (lastDirection != DIRECTION.dowm) {
                    velocity.x = 0
                    velocity.y = -pixelY
                }
            },
        ...
        loop: function () {
            ...
            if (!snakeStopped) {
                ...
                if (velocity.x == 0 && velocity.y == pixelY) lastDirection = DIRECTION.dowm
                ...
                if (snake[0].dy >= PIXEIS * pixelY && snake[0].direcao == DIRECTION.dowm) snake[0].dy = 0
                ...
                if (snake[0].direcao == DIRECTION.up || snake[0].direcao == DIRECTION.dowm) {
                ...
                if (snake[0].direcao == DIRECTION.up && snake[1].direcao == DIRECTION.right ||
                    snake[0].direcao == DIRECTION.left && snake[1].direcao == DIRECTION.dowm) {
                    newSplitSnake.sx = PIXEL_IMG * 2
                    newSplitSnake.sy = PIXEL_IMG * 2
                }
                if (snake[0].direcao == DIRECTION.dowm && snake[1].direcao == DIRECTION.left ||
                ...
                if (snake[0].direcao == DIRECTION.up && snake[1].direcao == DIRECTION.left ||
                    snake[0].direcao == DIRECTION.right && snake[1].direcao == DIRECTION.dowm) {
                    newSplitSnake.sx = PIXEL_IMG * 0
                    newSplitSnake.sy = PIXEL_IMG * 1
                }
                if (snake[0].direcao == DIRECTION.dowm && snake[1].direcao == DIRECTION.right ||
                ...
                if (snake[0].direcao == DIRECTION.dowm) {
                    splitHeadSnake.sx = PIXEL_IMG * 4
                ...
                if (snake[snake.length - 2].direcao == DIRECTION.dowm) {
                    splitFootSnake.sx = PIXEL_IMG * 4
